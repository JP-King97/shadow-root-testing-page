// BEGIN: main.js content moved from index.html
...
const lettersInput = nestedShadow.getElementById('letters-input');
...
const numbersInput = nestedShadow.getElementById('numbers-input');
...
if (mainDiv) {
  ...
  // Helper for message
  const showShadowMsg = (btnText, location) => {
    let msgDiv = document.createElement('div');
...
// END: main.js content moved from index.html
